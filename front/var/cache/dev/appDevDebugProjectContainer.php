...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.brewing.api' => 'getApp_Brewing_ApiService',
            ...
            'guzzle.client.api_node' => 'getGuzzle_Client_ApiNodeService',
            'guzzle_bundle.formatter' => 'getGuzzleBundle_FormatterService',
            'guzzle_bundle.logger' => 'getGuzzleBundle_LoggerService',
            'guzzle_bundle.middleware.event_dispatch.api_node' => 'getGuzzleBundle_Middleware_EventDispatch_ApiNodeService',
            'guzzle_bundle.middleware.log.api_node' => 'getGuzzleBundle_Middleware_Log_ApiNodeService',
    ...
    /**
     * Gets the 'app.brewing.api' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BrewingBundle\Api\BrewingApi A BrewingBundle\Api\BrewingApi instance
     */
    protected function getApp_Brewing_ApiService()
    {
        return $this->services['app.brewing.api'] = new \BrewingBundle\Api\BrewingApi($this->get('guzzle.client.api_node'));
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BrewingBundle', ($this->targetDirs[3].'/app/Resources/BrewingBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BrewingBundle', ($this->targetDirs[3].'/src/BrewingBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('lNAJpO59gA', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TjVHTyd0tG', 0, 'UkG214Pzl2NuV7UrZlnZCD', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4c3d7c340a8c6fecbff7108b1612489af0c5f571fa4b20a5ff9d1f7a14fdfc5b');
    ...
    /**
     * Gets the 'guzzle.client.api_node' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzle_Client_ApiNodeService()
    {
        $a = \GuzzleHttp\HandlerStack::create();
        $a->push($this->get("guzzle_bundle.middleware.log.api_node")->log());
        $a->unshift($this->get("guzzle_bundle.middleware.event_dispatch.api_node")->dispatchEvent());

        return $this->services['guzzle.client.api_node'] = new \GuzzleHttp\Client(array('base_uri' => 'beer-api.dev/', 'handler' => $a, 'headers' => array('Accept' => 'application/json', 'Content-Type' => 'application/ld+json')));
    }
    ...
    /**
     * Gets the 'guzzle_bundle.middleware.event_dispatch.api_node' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzleBundle_Middleware_EventDispatch_ApiNodeService()
    {
        return $this->services['guzzle_bundle.middleware.event_dispatch.api_node'] = new \EightPoints\Bundle\GuzzleBundle\Middleware\EventDispatchMiddleware($this->get('debug.event_dispatcher'), 'api_node');
    }

    /**
     * Gets the 'guzzle_bundle.middleware.log.api_node' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzleBundle_Middleware_Log_ApiNodeService()
    {
        return $this->services['guzzle_bundle.middleware.log.api_node'] = new \EightPoints\Bundle\GuzzleBundle\Middleware\LogMiddleware($this->get('guzzle_bundle.logger'), $this->get('guzzle_bundle.formatter'));
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('1tg6tZ4DsW', NULL, 'UkG214Pzl2NuV7UrZlnZCD', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/BrewingBundle/Resources/views'), 'Brewing');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d5d657876629bc90f204c36edec952e243466d47');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Z3SS5qTgfD', 0, 'UkG214Pzl2NuV7UrZlnZCD', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58f4cf1274a224.17891435')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'BrewingBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/BrewingBundle'),
                    'namespace' => 'BrewingBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BrewingBundle' => 'BrewingBundle\\BrewingBundle',
            ...
            'secret' => 'd5d657876629bc90f204c36edec952e243466d47',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'd5d657876629bc90f204c36edec952e243466d47',
